...
impl TileMatmulFamily for InterleavedDeferredMatmul {
    type Config = InterleavedDeferredMatmulConfig;
    type Matmul<L: Numeric, R: Numeric, A: Numeric> = InterleavedDeferredMatmul;
    ...
    fn expand_config(
        ...
        Ok(InterleavedDeferredMatmulConfig::from_shared_tile_config(
